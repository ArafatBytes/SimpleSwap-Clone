      ...
      <div className="relative">
        ...
        <div className="relative flex justify-between">
          {statuses.map((status, index) => {
            ...
            const isError = ["Failed", "Refunded", "Expired"].includes(
              currentStatus
            );
              ...
              <div key={status} className="flex flex-col items-center">
                <div
                  className={`
                    ...
                    ${
                      !isError && isCurrent
                        ? "bg-gradient-to-r from-purple-500 to-pink-500 shadow-lg shadow-pink-500/30 scale-110"
                        : ""
                    }
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto rounded-2xl shadow-2xl overflow-hidden">
            ...
            <div className="backdrop-blur-xl bg-white/5 p-8 relative">
              ...
              {/* Content */}
              <div className="relative">
                <h1 className="text-3xl font-bold text-center mb-8 bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text">
                ...
                <div className="space-y-6">
                  <div className="text-center">
                    ...
                    <p className="text-4xl font-bold text-green-400 mb-2">
                      ...
                      {paymentDetails.currency_from.toUpperCase()}
                    </p>
                  ...
                  <div className="bg-[#0B1426]/80 backdrop-blur-sm p-6 rounded-lg border border-blue-900/50">
                    <h2 className="text-xl font-semibold mb-4 text-center bg-gradient-to-r from-blue-400 to-purple-400 text-transparent bg-clip-text">
                      Operation Details
                    </h2>
                    <div className="space-y-4">
                      <div className="flex flex-col space-y-1">
                        ...
                        <p className="text-lg font-bold text-purple-400">
                          {paymentDetails.amount_to}{" "}
                          {paymentDetails.currency_to.toUpperCase()}
                        </p>
                      </div>
                      <div className="flex flex-col space-y-1">
                        <p className="text-sm text-gray-400">
                  ...
                  <div className="bg-yellow-900/20 backdrop-blur-sm border border-yellow-700/30 text-yellow-200 p-4 rounded-lg">
                    ...
                    <ul className="list-disc list-inside space-y-2">
                      <li>
                        Send only {paymentDetails.currency_from.toUpperCase()}{" "}
                        to this address
                      </li>
                      <li>
                        The payment should be sent in a single transaction
                      </li>
                      <li>Make sure to send the exact amount shown above</li>
                      <li>
                        The exchange rate will be locked after receiving the
                        payment
                      </li>
                    </ul>
                  </div>
                  ...
                  <div className="text-center text-sm text-gray-400">
                    <p>
                      The exchange will start automatically after receiving your
                      payment
                    </p>
                  </div>
                </div>
